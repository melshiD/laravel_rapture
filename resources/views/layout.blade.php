...
<title>Rapture Layout Template</title>
<link href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" rel="stylesheet">
<link rel="preconnect" href="https://fonts.gstatic.com">
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@400;600;700&display=swap" rel="stylesheet">
<script defer src="https://unpkg.com/alpinejs@3.x.x/dist/cdn.min.js"></script>
<!-- links for alpinejs, tailwind and google fonts  -->

<!-- <body class="m-0 font-sans font-serif"> -->
<body style="font-family: Open Sans, sans-serif; margin: 0; padding: 0;" class="m-0 font-sans font-serif">
    <section>
        <x-nav />
        <x-fancy-border />
